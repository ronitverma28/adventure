...
import { Search, MapPin, Calendar, Wallet, ChevronDown, AlertCircle } from 'lucide-react';
...
// Required fields
const REQUIRED_FIELDS = ['destination'] as const;
...
export function HeroSearchBar() {
  ...
  const handleSearch = () => {
    if (!validate()) {
      ...
      // Auto-open destination dropdown so user knows what to fill
            ...
            return (
              ...
              >
                <button
                  onClick={() => {
                    toggle(field.key);
                    // Clear error when user opens field
                    if (errors[field.key]) {
